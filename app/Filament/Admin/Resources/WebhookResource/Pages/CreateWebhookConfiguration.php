...
class CreateWebhookConfiguration extends CreateRecord
{
    ...
    public function mount(): void
    {
        ...
        $webhook->endpoint = 'https://mycoolendpoint.com';
        $webhook->events = ['server:created']; 
        $webhook->save();

        // This is a temporal fix, wip, when showing a normal page, wasn't saving correctly the record, but edit was, so best option was to create it and redirect to the edit page.
